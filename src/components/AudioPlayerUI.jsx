 ...
 * Аудио элемент управляется глобально через useGlobalAudio в App.jsx
 */
const AudioPlayerUI = ({ nashid, playlist = [], onClose, isMinimized, onToggleMinimize, audioState }) => {
  ...
  const { currentTime, duration, isLoading, audioError, setCurrentTime, setVolume: setAudioVolume } = audioState;
